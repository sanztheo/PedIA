...
- [x] **Embeddings pgvector** : Implémenter la génération et stockage des embeddings
- [x] **Service Embedding** : Créer `EmbeddingService` pour chunk/embed/store
- [x] **API embedding** : Endpoint pour générer embeddings (OpenAI text-embedding-3-small)
...
## Phase 4 - Quality & Trust 🔶 EN COURS
